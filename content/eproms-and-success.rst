...
:author: BleuLlama
:category: Projects
:slug: eproms-and-success
:status: published

This is a continuation of a  `previous article
<{filename}/eproms-and-failure.rst>`__.   Quick
...
result, we bought the  `"AMAX" Macintosh emulation system for the Amiga <http://crossconnect.tripod.com/AMAXHIST.HTML>`__.  It was a lot
...
up a few AMAX cartridges for $2 apiece at the awesome  `Active Surplus on Queen Street in Toronto <http://www.activesurplus.ca/en/>`__ a bunch
...
figuring out the best layout for the chips.  I used the ` DIY shield for Arduino from AdaFruit.com <https://www.adafruit.com/products/187>`__ as the
...
and pin 26 is used for Address line 13.  It's confusing.  `A table that shows all of the pinouts <https://docs.google.com/spreadsheet/ccc?key=0Ah_ZDi13ZcngdFlfcDJHWERpNUVGMlBYR0dvdE1kdnc>`__ doesn't
really help too much, but it was necessary so that I could figure things
out for wiring it up.

|image13| 

Next is firmware. I wrote a `pretty simple program for the Arduino <http://www.umlautllama.com/rand/ROM-Project-Arduino.txt>`__ that
